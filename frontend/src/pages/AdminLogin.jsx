        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="confirmAdmin" className="text-sm text-gray-700 dark:text-gray-100">
              I confirm I am logging in as an admin
            </label>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-700 via-teal-500 to-white dark:from-green-500 dark:via-blue-500 dark:to-green-400 p-[3px] rounded-xl">
            <button type="submit" disabled={loading || !confirmAdmin} className="w-full py-3 rounded-2xl text-lg font-semibold bg-blue-500 hover:bg-blue-600 text-white dark:bg-blue-700 dark:hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all">
